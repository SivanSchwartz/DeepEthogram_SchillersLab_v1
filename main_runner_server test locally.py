...
if __name__ == '__main__':
    project_path = 'H:/Models_deepEthogram/' # This is path example in my local machine 
    ...
    vid_path = r'C:\Users\Jackie.MEDICINE\Desktop\New folder\**.mp4'
    csv_path = r'C:\Users\Jackie.MEDICINE\Desktop\New folder\**.csv'
