...
if __name__ == '__main__':
    ...
    # vid_path = r'/home/sivan.s/DeepEthogramProject/deepethogram/small_dataset_deabug/*.mp4'
    # csv_path = r'/home/sivan.s/DeepEthogramProject/deepethogram/small_dataset_deabug/*.csv'
